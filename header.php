...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
    ...
    <meta name="robots" content="noindex">
    <?php endif; ?>
    <?php if (!get_post_meta($post->ID, 'jin_canonical', true) == null) : ?>
    <link rel="canonical" href="<?php echo get_post_meta($post->ID, 'jin_canonical', true); ?>">
    <?php endif; ?>
    <?php wp_head(); ?>
...
<body <?php body_class(); ?> id="<?php echo is_font_style(); ?>">
    <div id="wrapper">
        ...
        <a href='https://twitter.com/shusgw' class="tw_link" target="_blank" rel="noopener noreferrer">
            <i class=" jic jic jin-ifont-batu" id='toggle_original_twBtn'></i>
            <div class="tw_link_innerBox">
        ...
        <label for="navtoggle" class="sp-menu-open <?php is_sp_header_fix(); ?>"><span
                class="cps-icon-bar <?php is_animation_style(); ?>"></span><span
                class="cps-icon-bar <?php is_animation_style(); ?>"></span><span
                class="cps-icon-bar <?php is_animation_style(); ?>"></span></label>
        ...
        <div class="sp-menu-box">
            ...
            <div class="sp-sns-menu">
                <ul>
                    ...
                    <li class="pro-tw"><a href="<?php echo get_option('tw_page_url'); ?>" target="_blank"><i
                                class="jic-type jin-ifont-twitter"></i></a></li>
                    <?php endif; ?>
                    <?php if (get_option('fb_page_url')) : ?>
                    <li class="pro-fb"><a href="<?php echo get_option('fb_page_url'); ?>" target="_blank"><i
                                class="jic-type jin-ifont-facebook" aria-hidden="true"></i></a></li>
                    <?php endif; ?>
                    <?php if (get_option('insta_page_url')) : ?>
                    <li class="pro-insta"><a href="<?php echo get_option('insta_page_url'); ?>" target="_blank"><i
                                class="jic-type jin-ifont-instagram" aria-hidden="true"></i></a></li>
                    <?php endif; ?>
                    <?php if (get_option('youtube_page_url')) : ?>
                    <li class="pro-youtube"><a href="<?php echo get_option('youtube_page_url'); ?>" target="_blank"><i
                                class="jic-type jin-ifont-youtube" aria-hidden="true"></i></a></li>
                    <?php endif; ?>
                    <?php if (get_option('line_page_url')) : ?>
                    <li class="pro-line"><a href="<?php echo get_option('line_page_url'); ?>" target="_blank"><i
                                class="jic-type jin-ifont-line" aria-hidden="true"></i></a></li>
                    <?php endif; ?>
                    <?php if (get_option('contact_page_url')) : ?>
                    <li class="pro-contact"><a href="<?php echo get_option('contact_page_url'); ?>" target="_blank"><i
                                class="jic-type jin-ifont-mail" aria-hidden="true"></i></a></li>
                    <?php endif; ?>
                </ul>
            </div>
            <?php endif; ?>
